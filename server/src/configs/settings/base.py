...
class BackendBaseSettings(BaseSettings):
    ...
    DB_MYSQL_HOST: str = decouple.config("MYSQL_HOST", cast=str)  # type: ignore
    DB_MAX_POOL_CON: int = decouple.config("DB_MAX_POOL_CON", cast=int)  # type: ignore
    DB_MYSQL_NAME: str = decouple.config("MYSQL_DB", cast=str)  # type: ignore
    DB_MYSQL_PASSWORD: str = decouple.config("MYSQL_PASSWORD", cast=str)  # type: ignore
    ...
    DB_MYSQL_PORT: int = decouple.config("MYSQL_PORT", cast=int)  # type: ignore
    DB_MYSQL_SCHEMA: str = decouple.config("MYSQL_SCHEMA", cast=str)  # type: ignore
    DB_TIMEOUT: int = decouple.config("DB_TIMEOUT", cast=int)  # type: ignore
    DB_MYSQL_USERNAME: str = decouple.config("MYSQL_USERNAME", cast=str)  # type: ignore
